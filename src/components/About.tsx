      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            <h2 className="text-4xl md:text-5xl text-pink-500 font-bold mb-4 cursive">Our Story</h2>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-12 animate-fade-in">
            <h3 className="text-2xl text-pink-500 font-bold mb-4 cursive">How We Met</h3>
            ...
            <h3 className="text-2xl text-pink-500 font-bold mb-4 cursive">Our First Date</h3>
            <p className="text-gray-700 mb-6 leading-relaxed">
            ...
            <h3 className="text-2xl text-pink-500 font-bold mb-4 cursive">When We Knew</h3>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 animate-fade-in">
            <h3 className="text-2xl text-pink-500 font-bold mb-4 text-center cursive">Our Favorite Things</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h4 className="text-lg font-semibold text-pink-600 mb-2">Jenie's Favorites</h4>
              ...
              <div>
                <h4 className="text-lg font-semibold text-pink-600 mb-2">Arn's Favorites</h4>
                <ul className="list-disc list-inside space-y-2 text-gray-700">
                  <li>Favorite food: [food]</li>
                  <li>Favorite movie: [movie]</li>
                  <li>Favorite song: [song]</li>
